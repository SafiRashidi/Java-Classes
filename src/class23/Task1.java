...
class CreditCard {
    ...
    public CreditCard (double balance, double interests) {
        this.balance = balance;
        this.interest = interests;
    }

    public void calculateInterest() { //instance method -> a method which doesn't contain static keyword
